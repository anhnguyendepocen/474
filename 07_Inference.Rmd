...
3. Suppose that $X_i \stackrel{iid}{\sim} \textrm{Gamma}(\alpha, \beta)$. Find the MLE of $\theta = \alpha/\beta$.

4. Supppose that $X_i \stackrel{iid}{\sim} \textrm{Beta}( \alpha, \beta )$.
    a. Find the Method of Moment estimators for $\alpha$ and $\beta$.
    b. Show that these estimators are not the MLEs for $\alpha$ and $\beta$.
